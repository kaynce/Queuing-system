...
Public Class Login
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles loginBtn.Click
        Try
            ...
            Dim cmd1 = New OleDbCommand("select * from LoginRegistrar where Username = '" & usertxt.Text & "' and Password = '" & passtxt.Text & "'", con)
            ...
            If table1.Rows.Count <> 0 Then
                ...
                Dim str1 As String
                str1 = "insert into RegistrarHasLogin([HasLogin]) Values(?)"
                Using cmd2 As OleDbCommand = New OleDbCommand(str1, con)
                    ...
                    RegistrarPlace.updateRegandPLTimer.Enabled = True
                    RegistrarPlace.totalOnqueueTimer.Enabled = True
                    RegistrarPlace.newMonitorTimer.Enabled = True
                    RegistrarPlace.ableNotif.Checked = True
                    RegistrarPlace.priorityPLABLE.Checked = True
                    RegistrarPlace.Show()
                    usertxt.Clear()
                    passtxt.Clear()
                    Me.Hide()
