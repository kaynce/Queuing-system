...
Public Class RegistrarDone
    ...
    Private Sub Retrieve()
        ...
        Dim sql As String = "SELECT * FROM RegistrarDone"
    ...
    Private Sub ListView1_MouseDoubleClick(sender As Object, e As MouseEventArgs) Handles ListView1.MouseDoubleClick
        Try
            ...
            If confirm = vbYes Then
                ...
                RegistrarPlace.onqueuenumberTxt.Text = Number
                RegistrarPlace.onqueuepurposeTxt.Text = Purpose
                RegistrarPlace.onqueuestatusTxt.Text = Status

                RegistrarPlace.fordoneTxt.Text = Number

                RegistrarPlace.Holdbtn.Enabled = False
