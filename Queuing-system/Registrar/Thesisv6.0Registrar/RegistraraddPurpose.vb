...
Public Class RegistraraddPurpose
    ...
    Private Sub purpose1_TextChanged(sender As Object, e As EventArgs) Handles purpose1.TextChanged
        'If purpose1.Text.Length = 21 Then
        '    MsgBox("The maximum length character is 20", vbCritical, "")
        '    'purpose1.Clear()
        '    purpose1.Focus()
        'End If
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles updateBtn.Click
        Try
            ...
            Using con As OleDbConnection = New OleDbConnection(conString)
                ...
                Using cmd As New OleDbCommand("UPDATE RegistrarADDS SET Purpose1=pur1, Purpose2=pur2 , purpose3 =pur3,Purpose4=pur4, Purpose5=pur5 , purpose6 =pur6,Purpose7=pur7, Purpose8=pur8 , purpose9 =pur9", con)
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles showBtn.Click
        Try
            ...
            Using con As OleDbConnection = New OleDbConnection(conString)
                Using cmd1 As New OleDb.OleDbCommand("SELECT Purpose1 FROM RegistrarADDS", con)
                    Using cmd2 As New OleDb.OleDbCommand("SELECT Purpose2 FROM RegistrarADDS", con)
                        Using cmd3 As New OleDb.OleDbCommand("SELECT Purpose3 FROM RegistrarADDS", con)
                            Using cmd4 As New OleDb.OleDbCommand("SELECT Purpose4 FROM RegistrarADDS", con)
                                Using cmd5 As New OleDb.OleDbCommand("SELECT Purpose5 FROM RegistrarADDS", con)
                                    Using cmd6 As New OleDb.OleDbCommand("SELECT Purpose6 FROM RegistrarADDS", con)
                                        Using cmd7 As New OleDb.OleDbCommand("SELECT Purpose7 FROM RegistrarADDS", con)
                                            Using cmd8 As New OleDb.OleDbCommand("SELECT Purpose8 FROM RegistrarADDS", con)
                                                Using cmd9 As New OleDb.OleDbCommand("SELECT Purpose9 FROM RegistrarADDS", con)
                                                    con.Open()
