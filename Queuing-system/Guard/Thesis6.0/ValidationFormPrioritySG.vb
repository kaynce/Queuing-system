...
Public Class ValidationFormPrioritySG
    ...
    Private Sub ValidationFormPrioritySG_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub PrintDocument1_PrintPage(sender As Object, e As Printing.PrintPageEventArgs) Handles PrintDocument1.PrintPage
        ...
        e.Graphics.DrawString(NUMBER, fnt2, Brushes.Black, New PointF(14, 50))
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        Try
            Using con As OleDbConnection = New OleDbConnection(conString)
                Dim str1 As String
                str1 = "insert into SGQueue([Number]) Values(?)"
                Dim str2 As String
                str2 = "insert into SGPriorityLane([Number],[Purpose],[Status]) Values(?,?,?)"
