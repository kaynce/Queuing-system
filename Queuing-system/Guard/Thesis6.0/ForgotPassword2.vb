...
Public Class ForgotPassword2
    ...
    Private Sub Button2_Click_1(sender As Object, e As EventArgs) Handles Button2.Click
        ...
        Using con As OleDbConnection = New OleDbConnection(conString)
            Using cmd1 = New OleDbCommand("select * from LoginGuard where Question = '" & questionTxt.Text & "' and Answer = '" & answerTxt.Text & "'", con)
                    ...
                    Using table1 As New DataTable
                        ...
                        If table1.Rows.Count <> 0 Then
                            ...
                            Using con1 As OleDbConnection = New OleDbConnection(conString)
                                Using cmd2 As New OleDb.OleDbCommand("SELECT Password FROM LoginGuard", con)
