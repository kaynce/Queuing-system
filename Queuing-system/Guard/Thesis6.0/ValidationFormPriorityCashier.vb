...
Public Class ValidationFormPriorityCashier
    ...
    End Sub
    Private Sub ValidationFormPriorityAdmin_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        Try
            Using con As OleDbConnection = New OleDbConnection(conString)
                Dim str1 As String
                str1 = "insert into CashierQueue([Number]) Values(?)"
                Dim str2 As String
                str2 = "insert into CashierPriorityLane([Number],[Purpose],[Status]) Values(?,?,?)"
