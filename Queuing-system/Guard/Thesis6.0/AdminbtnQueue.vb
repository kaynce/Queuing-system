...
Public Class AdminbtnQueue
    ...
    Private Sub purpose1_Click(sender As Object, e As EventArgs) Handles purpose1.Click
        Using con As OleDbConnection = New OleDbConnection(conString)
            Using cmd = New OleDbCommand("select Max(Number) from AdminQueue ", con)
                Dim ID As Integer
                Dim value As String
                con.Open()
                ...
                ID = ID + 1
                value = "A" + ID.ToString("D4")

                ValidationFormAdmin.onqueuenumberTxt.Text = value
                ValidationFormAdmin.onqueuepurposeTxt.Text = purpose1.Text
                ValidationFormAdmin.ShowDialog()
            End Using
        End Using
    End Sub
    ...
    Private Sub closeTimer_Tick(sender As Object, e As EventArgs) Handles closeTimer.Tick
        Try
            Using con As OleDbConnection = New OleDbConnection(conString)
                Using cmd As New OleDbCommand("SELECT HasLogin FROM AdminHasLogin", con)
                    con.Open()
                    Dim dtareader As OleDbDataReader = cmd.ExecuteReader
                    If dtareader.HasRows = 0 Then
                        Me.Close()
                        ValidationFormAdmin.Close()
                        ValidationFormPriorityAdmin.Close()
                    End If
                End Using
            End Using
        Catch
    ...
    Private Sub purpose2_Click(sender As Object, e As EventArgs) Handles purpose2.Click
        Using con As OleDbConnection = New OleDbConnection(conString)
            Using cmd = New OleDbCommand("select Max(Number) from AdminQueue ", con)
                ...
                ValidationFormAdmin.onqueuenumberTxt.Text = value
                ValidationFormAdmin.onqueuepurposeTxt.Text = purpose2.Text
                ValidationFormAdmin.ShowDialog()
            End Using
        End Using
    End Sub
    ...
    Private Sub purpose3_Click(sender As Object, e As EventArgs) Handles purpose3.Click
        Using con As OleDbConnection = New OleDbConnection(conString)
            Using cmd = New OleDbCommand("select Max(Number) from AdminQueue ", con)
                ...
                ValidationFormAdmin.onqueuenumberTxt.Text = value
                ValidationFormAdmin.onqueuepurposeTxt.Text = purpose3.Text
                ValidationFormAdmin.ShowDialog()
    ...
    Private Sub purpose4_Click(sender As Object, e As EventArgs) Handles purpose4.Click
        Using con As OleDbConnection = New OleDbConnection(conString)
            Using cmd = New OleDbCommand("select Max(Number) from AdminQueue ", con)
                ...
                ValidationFormAdmin.onqueuenumberTxt.Text = value
                ValidationFormAdmin.onqueuepurposeTxt.Text = purpose4.Text
                ValidationFormAdmin.ShowDialog()
            End Using
        End Using
    End Sub
    ...
    Private Sub purpose5_Click(sender As Object, e As EventArgs) Handles purpose5.Click
        Using con As OleDbConnection = New OleDbConnection(conString)
            Using cmd = New OleDbCommand("select Max(Number) from AdminQueue ", con)
                ...
                ValidationFormAdmin.onqueuenumberTxt.Text = value
                ValidationFormAdmin.onqueuepurposeTxt.Text = purpose5.Text
                ValidationFormAdmin.ShowDialog()
            End Using
        End Using
    End Sub
    ...
    Private Sub purpose6_Click(sender As Object, e As EventArgs) Handles purpose6.Click
        Using con As OleDbConnection = New OleDbConnection(conString)
            Using cmd = New OleDbCommand("select Max(Number) from AdminQueue ", con)
                ...
                ValidationFormAdmin.onqueuenumberTxt.Text = value
                ValidationFormAdmin.onqueuepurposeTxt.Text = purpose6.Text
                ValidationFormAdmin.ShowDialog()
    ...
    Private Sub purpose7_Click(sender As Object, e As EventArgs) Handles purpose7.Click
        Using con As OleDbConnection = New OleDbConnection(conString)
            Using cmd = New OleDbCommand("select Max(Number) from AdminQueue ", con)
                ...
                ValidationFormAdmin.onqueuenumberTxt.Text = value
                ValidationFormAdmin.onqueuepurposeTxt.Text = purpose7.Text
                ValidationFormAdmin.ShowDialog()
    ...
    Private Sub purpose8_Click(sender As Object, e As EventArgs) Handles purpose8.Click
        Using con As OleDbConnection = New OleDbConnection(conString)
            Using cmd = New OleDbCommand("select Max(Number) from AdminQueue ", con)
                ...
                ValidationFormAdmin.onqueuenumberTxt.Text = value
                ValidationFormAdmin.onqueuepurposeTxt.Text = purpose8.Text
                ValidationFormAdmin.ShowDialog()
            End Using
        End Using
    End Sub
    ...
    Private Sub purpose9_Click(sender As Object, e As EventArgs) Handles purpose9.Click
        Using con As OleDbConnection = New OleDbConnection(conString)
            Using cmd = New OleDbCommand("select Max(Number) from AdminQueue ", con)
                ...
                ValidationFormAdmin.onqueuenumberTxt.Text = value
                ValidationFormAdmin.onqueuepurposeTxt.Text = purpose9.Text
                ValidationFormAdmin.ShowDialog()
    ...
    Private Sub purpose10_Click(sender As Object, e As EventArgs) Handles purpose10.Click
        Using con As OleDbConnection = New OleDbConnection(conString)
            Using cmd = New OleDbCommand("select Max(Number) from AdminQueue ", con)
                ...
                ValidationFormPriorityAdmin.onqueuenumberTxt.Text = "P-" + value
                ValidationFormPriorityAdmin.onqueuenumberTxt2.Text = value
                ValidationFormPriorityAdmin.onqueuepurposeTxt.Text = purpose10.Text
                ValidationFormPriorityAdmin.ShowDialog()
    ...
    Private Sub purpose11_Click(sender As Object, e As EventArgs) Handles purpose11.Click
        Using con As OleDbConnection = New OleDbConnection(conString)
            Using cmd = New OleDbCommand("select Max(Number) from AdminQueue ", con)
                ...
                ValidationFormPriorityAdmin.onqueuenumberTxt.Text = "P-" + value
                ValidationFormPriorityAdmin.onqueuenumberTxt2.Text = value
                ValidationFormPriorityAdmin.onqueuepurposeTxt.Text = purpose11.Text
                ValidationFormPriorityAdmin.ShowDialog()
            End Using
        End Using
    End Sub
    ...
    Private Sub purpose12_Click(sender As Object, e As EventArgs) Handles purpose12.Click
        Using con As OleDbConnection = New OleDbConnection(conString)
            Using cmd = New OleDbCommand("select Max(Number) from AdminQueue ", con)
                ...
                ValidationFormPriorityAdmin.onqueuenumberTxt.Text = "P-" + value
                ValidationFormPriorityAdmin.onqueuenumberTxt2.Text = value
                ValidationFormPriorityAdmin.onqueuepurposeTxt.Text = purpose12.Text
                ValidationFormPriorityAdmin.ShowDialog()
    ...
    Private Sub purpose13_Click(sender As Object, e As EventArgs) Handles purpose13.Click
        Using con As OleDbConnection = New OleDbConnection(conString)
            Using cmd = New OleDbCommand("select Max(Number) from AdminQueue ", con)
                ...
                ValidationFormPriorityAdmin.onqueuenumberTxt.Text = "P-" + value
                ValidationFormPriorityAdmin.onqueuenumberTxt2.Text = value
                ValidationFormPriorityAdmin.onqueuepurposeTxt.Text = purpose13.Text
                ValidationFormPriorityAdmin.ShowDialog()
    ...
    Private Sub purpose14_Click(sender As Object, e As EventArgs) Handles purpose14.Click
        Using con As OleDbConnection = New OleDbConnection(conString)
            Using cmd = New OleDbCommand("select Max(Number) from AdminQueue ", con)
                ...
                ValidationFormPriorityAdmin.onqueuenumberTxt.Text = "P-" + value
                ValidationFormPriorityAdmin.onqueuenumberTxt2.Text = value
                ValidationFormPriorityAdmin.onqueuepurposeTxt.Text = purpose14.Text
                ValidationFormPriorityAdmin.ShowDialog()
    ...
    Private Sub purpose15_Click(sender As Object, e As EventArgs) Handles purpose15.Click
        Using con As OleDbConnection = New OleDbConnection(conString)
            Using cmd = New OleDbCommand("select Max(Number) from AdminQueue ", con)
                ...
                ValidationFormPriorityAdmin.onqueuenumberTxt.Text = "P-" + value
                ValidationFormPriorityAdmin.onqueuenumberTxt2.Text = value
                ValidationFormPriorityAdmin.onqueuepurposeTxt.Text = purpose15.Text
                ValidationFormPriorityAdmin.ShowDialog()
    ...
    Private Sub purpose16_Click(sender As Object, e As EventArgs) Handles purpose16.Click
        Using con As OleDbConnection = New OleDbConnection(conString)
            Using cmd = New OleDbCommand("select Max(Number) from AdminQueue ", con)
                ...
                ValidationFormPriorityAdmin.onqueuenumberTxt.Text = "P-" + value
                ValidationFormPriorityAdmin.onqueuenumberTxt2.Text = value
                ValidationFormPriorityAdmin.onqueuepurposeTxt.Text = purpose16.Text
                ValidationFormPriorityAdmin.ShowDialog()
    ...
    Private Sub purpose17_Click(sender As Object, e As EventArgs) Handles purpose17.Click
        Using con As OleDbConnection = New OleDbConnection(conString)
            Using cmd = New OleDbCommand("select Max(Number) from AdminQueue ", con)
                ...
                ValidationFormPriorityAdmin.onqueuenumberTxt.Text = "P-" + value
                ValidationFormPriorityAdmin.onqueuenumberTxt2.Text = value
                ValidationFormPriorityAdmin.onqueuepurposeTxt.Text = purpose17.Text
                ValidationFormPriorityAdmin.ShowDialog()
            End Using
        End Using
    End Sub
    ...
    Private Sub purpose18_Click(sender As Object, e As EventArgs) Handles purpose18.Click
        Using con As OleDbConnection = New OleDbConnection(conString)
            Using cmd = New OleDbCommand("select Max(Number) from AdminQueue ", con)
                ...
                ValidationFormPriorityAdmin.onqueuenumberTxt.Text = "P-" + value
                ValidationFormPriorityAdmin.onqueuenumberTxt2.Text = value
                ValidationFormPriorityAdmin.onqueuepurposeTxt.Text = purpose18.Text
                ValidationFormPriorityAdmin.ShowDialog()
