...
Public Class ValidationFormCashier
    ...
    Private Sub ValidationFormAdmin_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        Try
            Using con As OleDbConnection = New OleDbConnection(conString)
                ...
                Dim str2 As String
                str2 = "insert into Cashier([Number],[Purpose],[Status]) Values(?,?,?)"
