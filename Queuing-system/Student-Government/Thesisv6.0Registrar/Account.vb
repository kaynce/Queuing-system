...
Public Class Account
    ...
    Private Sub btnSave_Click(sender As Object, e As EventArgs) Handles btnSave.Click
        Using con As OleDbConnection = New OleDbConnection(conString)
            ...
            Dim cmd1 = New OleDbCommand("select * from LoginSG where Username = '" & userTxt.Text & "'", con)
            ...
            cmd = New OleDbCommand("SELECT * FROM LoginSG", con)
    ...
    Private Sub UpdateRecord()
        ...
        If confirm = vbYes Then
            ...
            Using con As OleDbConnection = New OleDbConnection(conString)
                ...
                con.Open()
                cmd = New OleDbCommand("UPDATE LoginSG SET  [Password] = '" & newpass & "' WHERE ID = " & idsearch, con)
                cmd.ExecuteNonQuery()
