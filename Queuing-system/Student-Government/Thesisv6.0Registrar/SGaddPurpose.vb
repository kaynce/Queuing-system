...
Public Class SGaddPurpose
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles updateBtn.Click
        ...
        Using con As OleDbConnection = New OleDbConnection(conString)
            ...
            Using cmd As New OleDbCommand("UPDATE SGADDS SET Purpose1=pur1, Purpose2=pur2 , purpose3 =pur3,Purpose4=pur4, Purpose5=pur5 , purpose6 =pur6,Purpose7=pur7, Purpose8=pur8 , purpose9 =pur9", con)
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles showBtn.Click
        Try
            ...
            Using con As OleDbConnection = New OleDbConnection(conString)
                Using cmd1 As New OleDb.OleDbCommand("SELECT Purpose1 FROM SGADDS", con)
                    Using cmd2 As New OleDb.OleDbCommand("SELECT Purpose2 FROM SGADDS", con)
                        Using cmd3 As New OleDb.OleDbCommand("SELECT Purpose3 FROM SGADDS", con)
                            Using cmd4 As New OleDb.OleDbCommand("SELECT Purpose4 FROM SGADDS", con)
                                Using cmd5 As New OleDb.OleDbCommand("SELECT Purpose5 FROM SGADDS", con)
                                    Using cmd6 As New OleDb.OleDbCommand("SELECT Purpose6 FROM SGADDS", con)
                                        Using cmd7 As New OleDb.OleDbCommand("SELECT Purpose7 FROM SGADDS", con)
                                            Using cmd8 As New OleDb.OleDbCommand("SELECT Purpose8 FROM SGADDS", con)
                                                Using cmd9 As New OleDb.OleDbCommand("SELECT Purpose9 FROM SGADDS", con)
                                                    con.Open()
