...
Public Class CashierDone
    ...
    Private Sub Retrieve()
        ...
        Dim sql As String = "SELECT * FROM CashierDone"
    ...
    Private Sub ListView1_MouseDoubleClick(sender As Object, e As MouseEventArgs) Handles ListView1.MouseDoubleClick
        Try
            ...
            If confirm = vbYes Then
                ...
                CashierPlace.onqueuenumberTxt.Text = Number
                CashierPlace.onqueuepurposeTxt.Text = Purpose
                CashierPlace.onqueuestatusTxt.Text = Status

                CashierPlace.fordoneTxt.Text = Number

                CashierPlace.Holdbtn.Enabled = False
