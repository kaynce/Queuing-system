...
Public Class Login
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles loginBtn.Click
        Try
            ...
            Dim cmd1 = New OleDbCommand("select * from LoginCashier where Username = '" & usertxt.Text & "' and Password = '" & passtxt.Text & "'", con)
            ...
            Dim cmd3 As New OleDb.OleDbCommand("SELECT Password FROM LoginCashier", con)
            con.Open()
            ...
            If table1.Rows.Count <> 0 Then
                ...
                Dim str1 As String
                str1 = "insert into CashierHasLogin([HasLogin]) Values(?)"
                Using cmd2 As OleDbCommand = New OleDbCommand(str1, con)
                    ...
                    CashierPlace.updateRegandPLTimer.Enabled = True
                    CashierPlace.totalOnqueueTimer.Enabled = True
                    CashierPlace.newMonitorTimer.Enabled = True
                    CashierPlace.ableNotif.Checked = True
                    CashierPlace.priorityPLABLE.Checked = True
                    CashierPlace.Show()
