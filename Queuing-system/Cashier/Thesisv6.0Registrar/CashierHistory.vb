...
Public Class CashierHistory
    ...
    Private Sub CashierHistory_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Next printer
        CashierHistoryDataGridView.CellBorderStyle = DataGridViewCellBorderStyle.SingleHorizontal
        ...
        Next printer
        CashierOnholdHistoryDataGridView.CellBorderStyle = DataGridViewCellBorderStyle.SingleHorizontal
        ...
        CashierHistoryDataGridView.AdvancedCellBorderStyle.Left = DataGridViewAdvancedCellBorderStyle.None
        CashierHistoryDataGridView.AdvancedCellBorderStyle.Right = DataGridViewAdvancedCellBorderStyle.None
        CashierHistoryDataGridView.AdvancedCellBorderStyle.Bottom = DataGridViewAdvancedCellBorderStyle.None
        CashierHistoryDataGridView.AdvancedCellBorderStyle.Top = DataGridViewAdvancedCellBorderStyle.None

        CashierHistoryDataGridView.DefaultCellStyle.SelectionBackColor = CashierHistoryDataGridView.DefaultCellStyle.BackColor
        CashierHistoryDataGridView.DefaultCellStyle.SelectionForeColor = CashierHistoryDataGridView.DefaultCellStyle.ForeColor

        'RegistrarOnholdHistoryDatagird
        CashierOnholdHistoryDataGridView.AdvancedCellBorderStyle.Left = DataGridViewAdvancedCellBorderStyle.None
        CashierOnholdHistoryDataGridView.AdvancedCellBorderStyle.Right = DataGridViewAdvancedCellBorderStyle.None
        CashierOnholdHistoryDataGridView.AdvancedCellBorderStyle.Bottom = DataGridViewAdvancedCellBorderStyle.None
        CashierOnholdHistoryDataGridView.AdvancedCellBorderStyle.Top = DataGridViewAdvancedCellBorderStyle.None

        CashierOnholdHistoryDataGridView.DefaultCellStyle.SelectionBackColor = CashierOnholdHistoryDataGridView.DefaultCellStyle.BackColor
        CashierOnholdHistoryDataGridView.DefaultCellStyle.SelectionForeColor = CashierOnholdHistoryDataGridView.DefaultCellStyle.ForeColor
        ...
        Try
            ...
            Using con As OleDbConnection = New OleDbConnection(conString)
                Using ds1 As New DataSet
                    ...
                    adapter.Fill(ds1)
                    CashierHistoryDataGridView.DataSource = ds1.Tables(0)
                    CashierHistoryDataGridView.Columns.Remove("ID")
                End Using
            End Using
        Catch
            'MsgBox("")
        ...
        Try
            ...
            Using con As OleDbConnection = New OleDbConnection(conString)
                Using ds1 As New DataSet
                    ...
                    adapter.SelectCommand = New OleDb.OleDbCommand(str1, con)
                    adapter.Fill(ds1)
                    CashierOnholdHistoryDataGridView.DataSource = ds1.Tables(0)
                    CashierOnholdHistoryDataGridView.Columns.Remove("ID")
                End Using
            End Using
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs)
        ...
        Try
            ...
            Using con As OleDbConnection = New OleDbConnection(conString)
                Using ds1 As New DataSet
                    Dim str1 As String = "select * from CashierHistory"
    ...
    Private Sub Button5_Click(sender As Object, e As EventArgs)
        Try
            ...
            Using con As OleDbConnection = New OleDbConnection(conString)
                Using ds1 As New DataSet
                    Dim str1 As String = "select * from CashierOnholdHistory"
