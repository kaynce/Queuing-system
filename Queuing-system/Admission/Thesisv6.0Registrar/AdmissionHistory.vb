...
Public Class AdmissionHistory
    ...
    Private Sub RegistrarHistory_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Next printer
        AdminHistoryDataGridView.CellBorderStyle = DataGridViewCellBorderStyle.SingleHorizontal
        ...
        Next printer
        AdminOnholdHistoryDataGridView.CellBorderStyle = DataGridViewCellBorderStyle.SingleHorizontal
        ...
        AdminHistoryDataGridView.AdvancedCellBorderStyle.Left = DataGridViewAdvancedCellBorderStyle.None
        AdminHistoryDataGridView.AdvancedCellBorderStyle.Right = DataGridViewAdvancedCellBorderStyle.None
        AdminHistoryDataGridView.AdvancedCellBorderStyle.Bottom = DataGridViewAdvancedCellBorderStyle.None
        AdminHistoryDataGridView.AdvancedCellBorderStyle.Top = DataGridViewAdvancedCellBorderStyle.None

        AdminHistoryDataGridView.DefaultCellStyle.SelectionBackColor = AdminHistoryDataGridView.DefaultCellStyle.BackColor
        AdminHistoryDataGridView.DefaultCellStyle.SelectionForeColor = AdminHistoryDataGridView.DefaultCellStyle.ForeColor

        'RegistrarOnholdHistoryDatagird
        AdminOnholdHistoryDataGridView.AdvancedCellBorderStyle.Left = DataGridViewAdvancedCellBorderStyle.None
        AdminOnholdHistoryDataGridView.AdvancedCellBorderStyle.Right = DataGridViewAdvancedCellBorderStyle.None
        AdminOnholdHistoryDataGridView.AdvancedCellBorderStyle.Bottom = DataGridViewAdvancedCellBorderStyle.None
        AdminOnholdHistoryDataGridView.AdvancedCellBorderStyle.Top = DataGridViewAdvancedCellBorderStyle.None

        AdminOnholdHistoryDataGridView.DefaultCellStyle.SelectionBackColor = AdminOnholdHistoryDataGridView.DefaultCellStyle.BackColor
        AdminOnholdHistoryDataGridView.DefaultCellStyle.SelectionForeColor = AdminOnholdHistoryDataGridView.DefaultCellStyle.ForeColor
        ...
        Try
            ...
            Using con As OleDbConnection = New OleDbConnection(conString)
                Using ds1 As New DataSet
                    Dim str1 As String = "select * from AdminHistory"

                    adapter.SelectCommand = New OleDb.OleDbCommand(str1, con)
                    adapter.Fill(ds1)
                    AdminHistoryDataGridView.DataSource = ds1.Tables(0)
                    AdminHistoryDataGridView.Columns.Remove("ID")
                    AdminHistoryDataGridView.Columns.Remove("Number")
                End Using
            End Using
        Catch
            'MsgBox("")
        ...
        Try
            ...
            Using con As OleDbConnection = New OleDbConnection(conString)
                Using ds1 As New DataSet
                    Dim str1 As String = "select * from AdminOnholdHistory"

                    adapter.SelectCommand = New OleDb.OleDbCommand(str1, con)
                    adapter.Fill(ds1)
                    AdminOnholdHistoryDataGridView.DataSource = ds1.Tables(0)
                    AdminOnholdHistoryDataGridView.Columns.Remove("ID")
                    AdminOnholdHistoryDataGridView.Columns.Remove("Number")
                End Using
            End Using
    ...
    Private Sub PrintDocument1_PrintPage(sender As Object, e As Printing.PrintPageEventArgs) Handles PrintDocument1.PrintPage
        ...
        Dim bmc As New Bitmap(AdminHistoryDataGridView.Width, AdminHistoryDataGridView.Height)
        AdminHistoryDataGridView.DrawToBitmap(bmc, New Rectangle(0, 0, AdminHistoryDataGridView.Width, AdminHistoryDataGridView.Height))
        e.Graphics.DrawImage(bmc, 10, 10)
    ...
    Private Sub Button3_Click_1(sender As Object, e As EventArgs) Handles Button3.Click
        ...
        'PrintDialog1.Document = PrintDocument1
        PrintDialog1.PrintToFile = PrintAction.PrintToPreview
