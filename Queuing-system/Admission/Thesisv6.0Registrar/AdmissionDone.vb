...
Public Class AdmissionDone
    ...
    Private Sub Retrieve()
        ...
        Dim sql As String = "SELECT * FROM AdminDone"
    ...
    Private Sub ListView1_MouseDoubleClick(sender As Object, e As MouseEventArgs) Handles ListView1.MouseDoubleClick
        Try
            ...
            If confirm = vbYes Then
                ...
                AdmissionPlace.onqueuenumberTxt.Text = Number
                AdmissionPlace.onqueuepurposeTxt.Text = Purpose
                AdmissionPlace.onqueuestatusTxt.Text = Status

                AdmissionPlace.fordoneTxt.Text = Number

                AdmissionPlace.Holdbtn.Enabled = False
